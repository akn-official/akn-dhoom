...
export function AKNPortfolioDesign({ works }: { works: Work[] }) {
  ...
  const navigate = useCallback((dir: -1 | 1) => {
    setModalIdx((cur) => {
      ...
      return (cur + dir + PORTFOLIO_PROJECTS.length) % PORTFOLIO_PROJECTS.length;
    });
  }, []);
    ...
    <div style={{ background: BG, color: FG, fontFamily: DISPLAY, minHeight: '100vh' }}>
      ...
      <section style={{ minHeight: '100vh', padding: 'clamp(24px, 4vw, 56px)', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 40, flexWrap: 'wrap' }}>
          ...
          <a href="#akn-work" style={{ fontFamily: MONO, fontSize: 11, letterSpacing: '0.25em', textTransform: 'uppercase', color: FG, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 12 }}>
      ...
      {/* CAROUSEL */}
      <section id="akn-work" style={{ padding: 'clamp(60px, 10vw, 140px) 0' }}>
